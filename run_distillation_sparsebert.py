...
def parse_args():
    ...
    parser.add_argument("--sparsity", type=str, default="90", help="Sparsity.")
...
def main():
    ...
    if os.path.isfile(os.path.join(args.student_model_name_or_path, "pytorch_model.bin")):
    ...
    if "sparse" in args.model_type:
        base_model = getattr(s_model, s_model.base_model_prefix, s_model)
        base_model.sparsify(args.sparsity)
        base_model.densify()
            ...
            if step % args.num_grad_accum_steps == 0 or step == len(train_loader) - 1:
                ...
                if num_completed_steps % args.log_interval == 0:
                    ...
                    if is_main:
                        ...
                        s_config.sparsity = args.sparsity
