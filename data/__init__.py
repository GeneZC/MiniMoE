...
from data.pipelines import (
    BertMLMDataPipeline,
    BertNILDataPipeline,
    RobertaMLMDataPipeline,
    RobertaNILDataPipeline,
)


PIPELINE_CLASS = {
    "bert_mlm": BertMLMDataPipeline,
    "bert_nil": BertNILDataPipeline,
    "roberta_mlm": RobertaMLMDataPipeline,
    "roberta_nil": RobertaNILDataPipeline,
}
