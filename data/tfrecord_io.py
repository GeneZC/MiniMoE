...
class TFRecordReader:
    ...
    def __init__(self, record_path_or_regex, description=None):
        ...
        self.record_index_group = [index(record_path + ".index") for record_path in self.record_path_group]
    ...
    def process_feature(feature, key, typename):
        ...
        # (either "float_list", or "int64_list")!
        ...
        if inferred_typename == "float_list":
