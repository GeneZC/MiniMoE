...
python -m torch.distributed.launch --nproc_per_node=8 --master_port 37776 run_distillation_ofabert.py \
    --model_type ofabert_minilm \
    ...
    --hidden 768 \
    --ofa_layer "6,4,3" \
    --ofa_hidden "768,512,384,256,192" \
    --model_suffix 6L_768H