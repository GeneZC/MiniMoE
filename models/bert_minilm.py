...
from modules.modeling_bert import BertPreTrainedModel, BertModel

import collections


class BertMiniLM(BertPreTrainedModel):
    ...
    def forward(self, inputs):
        ...
        #     qq_relations = all_qq_relations[-4]
        #     kk_relations = all_kk_relations[-4]
        #     vv_relations = all_vv_relations[-4]
        # else:
